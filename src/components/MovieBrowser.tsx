...
function MovieTile({ movie }: { movie: SearchMovie }) {
	return (
		<a href="#" className="block rounded-lg p-4 shadow-sm border-solid border-2 border-slate-700 w-40">
			{movie.poster_path ? <Image src={movie.poster_path} width={100} height={200} alt={`${movie.original_title} poster`}
				...
				<div className="mt-6 flex items-center gap-8 text-xs">
					<div className="sm:inline-flex sm:shrink-0 sm:items-center sm:gap-2">
						<div className="mt-1.5 sm:mt-0">
							<p className="text-gray-500 break-before-all w-8/12">{movie.original_title}</p>
